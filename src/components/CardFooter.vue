<template>
    <div>
        ...
        <div class="text-center">
            <a href="https://www.facebook.com/monikaupretyprofile"
            ...
            <a href="https://www.instagram.com/monika.uprety/"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"><font-awesome-icon
                    icon="fa-brands fa-instagram" /></a>
            <a href="https://github.com/monikauprety"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
                    icon="fa-brands fa-github" /></a>
            <a href="mailto:monikauprety0011@gmail.com"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
